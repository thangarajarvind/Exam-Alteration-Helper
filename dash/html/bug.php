        ...
        <div class="content-wrapper">
            <div class="row">
              <div class="col-md-5 col-md-offset-1">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Raise bug</h4>
                      <form class="forms-sample" action="../php/bug.php" method="POST">  
                      <p>We apologise for the inconvenience. Please describe the issue you are facing and we will get back to you with a fix.</p>
                        <div class="form-group">
                            <label for="exampleInputUsername1" class="bmd-label-floating">Subject</label>
                        <input type="text" class="form-control" name="sub" required="" />
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1" class="bmd-label-floating">Description</label>
