...
<head>
  <?php
    ...
    if ($result->num_rows > 0) {
        ...
        echo "setTimeout(function () { Swal.fire('','Invalid Name','error').then(function (result) {if (result.value) {window.location = 'ctt.php';}})";
        echo '},100);</script>';
    }
?>
                ...
                <div class="card">
                    ...
                    if($flag == 1){
                            echo '<table class="table table-hover table-bordered table-striped">
                                <thead>';
                                echo '<br>';
                                echo '<h3 style="text-align:center">Timetable of '.$sname.'</h3>';
                                echo '<br>';
                                    echo '<tr>
