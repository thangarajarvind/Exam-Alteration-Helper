...
<head>
  ...
  <script type="text/javascript" src="../assets/js/plugins/table.js"></script>
</head>
  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
          <div class="container-fluid">
            <div class="navbar-wrapper">
              <a class="navbar-brand" href="javascript:;">View Faculty Timetable</a>
            </div>
        ...
        <div class="col-12">
            ...
            <a class="nav-link" href="./timetableedit.html"><button type="submit" class="btn btn-primary pull-right">Edit</button></a>
        ...
        <footer class="footer">
            <div class="container-fluid">
              ...
              <div class="copyright float-right">
                ...
                <a href="https://www.creative-tim.com" target="_blank">Creative labs</a> for a better web.
              </div>
            </div>
          </footer>
        </div>
