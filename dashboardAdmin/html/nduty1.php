...
<head>
  ...
  <link rel="stylesheet" media="screen" type="text/css" href="../assets/css/datepicker.css" />
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  ...
                  <a class="dropdown-item" href="../../login/html/index.html">Log out</a>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-4">
              ...
              <form name="myform" action="../php/roomalloc.php" method="POST">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0">Rooms Available</h4>
                  <p class="card-category">For the selected date and hour, the following rooms are available</p>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                          <?php
                            $free = $_SESSION['free'];
                            #var_dump($free);
                            $free = array_values(array_filter($free));
                            for ($i = 0; $i < count($free); $i++) {
                                $n = $free[$i];
                                #echo $n;
                                echo "<tr><td> <input type='checkbox' id='$n' name='roomalloc[]' value='$n'> </td><td>" . $n. "</td></tr>";
                            }
                            echo "</table>";
                          ?>
                      </tbody>
